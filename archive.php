...
<?php include 'config.php';?>
	...
	/* ===================== Pagination Code Starts ================== */
			...
			$sql = "SELECT * FROM tbl_post WHERE year = $year1 AND month = $month1 ORDER BY post_id DESC";
		...
		$total_pages = mysqli_num_rows($result);
          ...
          $sql = "SELECT * FROM tbl_post WHERE year = $year1 AND month = $month1 ORDER BY post_id DESC LIMIT $start, $limit";
			$result = mysqli_query($conn,$sql);
		...
		?>
				...
				<div class="description">
					<p><img src="uploads/<?php echo $row['post_image']; ?>" alt="" width="200" />
						<?php
